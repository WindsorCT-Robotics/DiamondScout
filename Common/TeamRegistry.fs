    ...
    module private Event =
        let evolve registry event =
            ...
            | TeamRegistered teamNumber ->
                { registry with Teams = registry.Teams.Add teamNumber }
            | TeamUnregistered teamNumber ->
                { registry with Teams = registry.Teams.Remove teamNumber }
